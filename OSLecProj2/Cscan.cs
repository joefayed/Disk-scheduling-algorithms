...
namespace OSLecProj2
{
    public partial class Cscan : Form
    {
        ...
        public Cscan()
        {
            ...
            this.Load+=Cscan_Load;
            this.Paint += Cscan_Paint;
            this.FormClosing += Cscan_FormClosing;
            this.Text = "C-SCAN";
        ...
        void Cscan_FormClosing(object sender, FormClosingEventArgs e)
        {
            tt.Stop();
            tt.Dispose();
        }
        ...
        void Cscan_Paint(object sender, PaintEventArgs e)
        {
            DrawDubb(e.Graphics);
        }

        private void Cscan_Load(object sender, EventArgs e)
        {
