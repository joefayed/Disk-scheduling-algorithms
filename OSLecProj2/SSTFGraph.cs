...
{
    public partial class SSTFGraph : Form
    {
        Bitmap off;
        Timer tt = new Timer();
        ...
        public SSTFGraph()
        {
            ...
            this.Load+=SSTFGraph_Load;
            this.Paint += SSTFGraph_Paint;
            this.FormClosing += SSTFGraph_FormClosing;
            this.Text = "SSTF";
        ...
        void SSTFGraph_FormClosing(object sender, FormClosingEventArgs e)
        {
            tt.Stop();
            tt.Dispose();
        }
        ...
        void SSTFGraph_Paint(object sender, PaintEventArgs e)
        {
            DrawDubb(e.Graphics);
        }

      
        private void SSTFGraph_Load(object sender, EventArgs e)
        {
