...
namespace OSLecProj2
{
    public partial class Scan : Form
    {
        ...
        public Scan()
        {
            ...
            this.Load+=Scan_Load;
            this.Paint += Scan_Paint;
            this.FormClosing += Scan_FormClosing;
            this.Text = "SCAN";
        ...
        void Scan_FormClosing(object sender, FormClosingEventArgs e)
        {
            tt.Stop();
            tt.Dispose();
        }
        ...
        void Scan_Paint(object sender, PaintEventArgs e)
        {
            DrawDubb(e.Graphics);
        }
